        ...
        <section className={style.main_section}>
            <div className={style.div_search}>
                ...
                <div className={style.div_bar}>
                    ...
                    />
                    <button
                        className={displayButton ? style.button_search : style.button_inactive}
                        onClick={() => { madeSearch() }}
                    >Search
                   </button>
                </div>
            ...
            <div className={style.div_checkpoint}>
                <div className={style.div_container}>
                    <div className={style.div_input}>
                        <label className={style.label} htmlFor="public">Public</label>
                        <input className={style.input} id="public" type="checkbox" />
                    </div>
                    <div className={style.div_input}>
                        <label className={style.label} htmlFor="private">Private</label>
                        <input className={style.input} id="private" type="checkbox" />
                    </div>
                    <div className={style.div_input}>
                        <label className={style.label} htmlFor="all">All</label>
